            ...
            <div className="relative z-10 w-full max-w-max-w mx-auto px-s6 max-md:px-s4 pt-[calc(var(--spacing-nav-h)+6rem)] pb-section-py">
              <RevealSection>
                <nav className="flex items-center gap-2 text-xs tracking-wide mb-s6" style={{ color: "rgba(245,244,239,0.45)" }}>
                  ...
                  <span style={{ color: "rgba(245,244,239,0.7)" }}>Shoulder Pain</span>
                </nav>
              </RevealSection>
              <SplitReveal text="Shoulder Pain Relief in Fairfax, VA at Roselle Center for Healing" as="h1" className="text-fluid-5xl text-bg tracking-tight leading-[1.05]" />
            </div>
          </section>
          ...
          <section className="bg-bg py-section-py overflow-hidden">
            <div className="w-full max-w-max-w mx-auto px-s6 max-md:px-s4">
              <div className="grid grid-cols-[1fr_1fr] gap-s10 items-center max-[900px]:grid-cols-1 max-[900px]:gap-s8">
                <div>
                  <RevealSection>
                    <p className="inline-flex items-center gap-1.5 text-xs tracking-widest uppercase text-accent mb-s3 font-sans">Shoulder Pain Treatment</p>
                  </RevealSection>
                  <RevealSection delay={0.1}>
                    <p className="text-fluid-base leading-relaxed mt-s6" style={{ color: "rgba(42,41,40,0.68)" }}>
                      Shoulder pain is a common issue that can affect individuals of all ages. It can range from mild discomfort to severe pain that limits daily activities. The shoulder is a complex joint, and pain in this area can be caused by a variety of factors, including injuries, overuse, and underlying health conditions. Before you visit the Roselle Center for Healing in Fairfax, VA, learn how chiropractic can provide relief below:
                    </p>
                  </RevealSection>
                </div>
                <RevealSection delay={0.15}>
                  <GsapImageParallax src="https://cdcssl.ibsrv.net/ibimg/smb/1023x683_80/webmgr/0g/5/2/shoulder-pain.jpg.webp?87756b3fb4340ccc8f0c5f109a391a36" alt="Man experiencing shoulder pain, holding his shoulder, illustrating the impact of shoulder injuries and conditions." className="w-full rounded-xl" />
                </RevealSection>
              </div>
            </div>
          </section>
          ...
          <section className="about-noise bg-fg py-section-py overflow-hidden relative">
            <div className="w-full max-w-max-w mx-auto px-s6 max-md:px-s4 relative z-1">
              <RevealSection>
                ...
                <SplitReveal text="Common Causes of Shoulder Pain" as="h2" className="text-fluid-3xl text-bg tracking-tight leading-[1.12] max-w-[32ch]" />
              </RevealSection>
              <RevealSection delay={0.1}>
                <p className="text-fluid-base leading-relaxed mt-s6 max-w-[720px]" style={{ color: "rgba(245,244,239,0.55)" }}>
                  Several conditions can lead to shoulder pain. Some of these conditions include rotator cuff injuries, bursitis, tendonitis, and arthritis. In some cases, shoulder pain may result from a sudden injury, such as a fall or sports-related incident. Chronic conditions, like osteoarthritis, can also contribute to ongoing discomfort in the shoulder.
                </p>
              </RevealSection>
            </div>
          </section>

          {/* LIGHT section - Chiropractic Care */}
          <section className="bg-bg py-section-py overflow-hidden">
            <div className="w-full max-w-max-w mx-auto px-s6 max-md:px-s4">
              <RevealSection>
          ...
          <section className="about-noise bg-fg py-section-py overflow-hidden relative">
            <div className="w-full max-w-max-w mx-auto px-s6 max-md:px-s4 relative z-1">
              <RevealSection>
                ...
                <SplitReveal text="The Benefits of Chiropractic Care" as="h2" className="text-fluid-3xl text-bg tracking-tight leading-[1.12] max-w-[32ch]" />
              </RevealSection>
              <RevealSection delay={0.1}>
                <p className="text-fluid-base leading-relaxed mt-s6 max-w-[720px]" style={{ color: "rgba(245,244,239,0.55)" }}>
                  One of the main benefits of chiropractic care for shoulder pain is that it addresses the root cause of the pain, rather than just masking the symptoms. This holistic approach can lead to long-term relief and improved shoulder function. Additionally, chiropractic care is drug-free and non-invasive, making it a safe choice for many patients.
                </p>
              </RevealSection>
            </div>
          </section>

          {/* LIGHT section - First Visit */}
          <section className="bg-bg py-section-py overflow-hidden">
            <div className="w-full max-w-max-w mx-auto px-s6 max-md:px-s4">
              <RevealSection>
                ...
                <SplitReveal text="What to Expect During Your First Visit" as="h2" className="text-fluid-3xl text-fg tracking-tight leading-[1.12] max-w-[32ch]" />
              </RevealSection>
              <RevealSection delay={0.1}>
                <p className="text-fluid-base leading-relaxed mt-s6 max-w-[720px]" style={{ color: "rgba(42,41,40,0.68)" }}>
                  When you visit us, we will discuss your symptoms with you and perform a physical exam. After, our chiropractors will create a personalized treatment plan for your specific needs. At this time, we can also address any questions or concerns you may have about your care plan.
                </p>
              </RevealSection>
            </div>
          </section>
              ...
              <RevealSection>
                <div className="flex items-center justify-between gap-s6 p-s8 px-s10 rounded-xl max-md:flex-col max-md:text-center max-md:p-s6 max-md:px-s4 bg-card-bg">
                  <div className="flex flex-col gap-s3 max-w-[560px]">
                    <h3 className="text-fluid-2xl text-fg font-serif font-medium tracking-tight leading-snug">Contact the Roselle Center for Healing for an Appointment Today</h3>
                    <p className="text-fluid-base leading-relaxed" style={{ color: "rgba(42,41,40,0.6)" }}>If you are seeking shoulder pain treatment, let our team at the Roselle Center for Healing in Fairfax, VA, help. To learn more about our techniques and to schedule your consultation, contact our office at (703) 698-7117. You can also browse our website to find out about our services or stop by in person. When you need a chiropractor near you, we are happy to assist you!</p>
                  </div>
