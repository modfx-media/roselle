...
// Real Google reviews from rosellecare.com
const T = [
  {
    ...
    name: "Rhonda L.",
    date: "April 2026",
    img: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=600&h=600&fit=crop&crop=face",
    av: "https://i.pravatar.cc/80?img=25",
  },
  {
    cat: "Wellbeing",
    title: "Multi-Pronged Approach",
    quote: "Roselle Center for Healing has been such a boon to both my mental and physical health. Their multi-pronged approach fits in well with my personal outlook on health and wellness.",
    name: "Elizabeth S.",
    date: "April 2026",
  ...
  },
  {
    ...
    name: "Holly S.",
    date: "April 2026",
    img: "https://images.unsplash.com/photo-1559757175-0eb30cd8c063?w=600&h=600&fit=crop",
  ...
  },
  {
    ...
    name: "Rick W.",
    date: "April 2026",
    img: "https://images.unsplash.com/photo-1490645935967-10de6ba17061?w=600&h=600&fit=crop",
        ...
        <div className="site-container">
          <RevealSection>
            <div className="testimonials-header">
              ...
              <p>
                4.5★ on Google · 52 reviews · Fairfax, VA
              </p>
            </div>
          </RevealSection>
            ...
            <div style={{ textAlign: "center", marginTop: "var(--s6)" }}>
              <a
                ...
                style={{
                  ...
                  borderBottom: "1px solid rgba(245,244,239,0.25)",
                  paddingBottom: "2px",
