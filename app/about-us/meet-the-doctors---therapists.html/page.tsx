...
const TEAM = [
  ...
  { name: "Mary Jane Bembenek, MS, CNS, LDN", role: "Certified Nutrition Specialist", image: "https://cdcssl.ibsrv.net/ibimg/smb/800x1004_80/webmgr/0g/5/2/mary-jane-bembenek.jpg.webp?64d7791ad995a5a619e39e430dbc4b57", alt: "Mary Jane Bembenek.", bio: ["Mary Jane Bembenek, MS, CNS, LDN is a Certified Nutrition Specialist. She earned her Master of Science in Nutrition and Integrative Health through Maryland University of Integrative Health.", "She is a perceptive listener dedicated to providing integrative, holistic, and nourishing solutions to enhance health and wellness outcomes."] },
  ...
  { name: "Connie Kern, LAc, MSOM", role: "Acupuncturist & Chief Operating Officer", image: "https://cdcssl.ibsrv.net/ibimg/smb/800x1175_80/webmgr/0g/5/2/5b29780519c7e_RoselleConnie2013.png.webp?de01b87c97bb933b906740d40830a454", alt: "Connie Kern.", bio: ["Consuelo Kern received her undergraduate training from George Mason University and obtained her Master in Traditional Chinese Medicine from Mid West College of Oriental Medicine.", "Ms. Kern has been with Roselle Center for Healing since 1986, serving as corporate supervisor and Chief Operating Officer."] },
  ...
  { name: "Sybil McFarland", role: "Community Outreach", image: "https://cdcssl.ibsrv.net/ibimg/smb/800x1040_80/webmgr/0g/5/2/Roselle_Sybil.png.webp?ddf75279a190675c28b5bdafa21852ec", alt: "Sybil McFarland.", bio: ["With 35+ years of experience in hospitality, Sybil McFarland has a unique perspective on customer patient care.", "Sybil is skilled in creating community outreach events for the Roselle Center for Healing, the Thermography Centers of Fairfax and Caring for Others, Ltd."] },
];
